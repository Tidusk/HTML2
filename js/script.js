...
function showList(list, buttom = "all") {
    ...
    if (buttom == 'graphic') {
        ...
        list[12].classList.add('active');
        list[13].classList.add('active');
        list[14].classList.add('active');

    }
    if (buttom == 'webSite') {
        list[15].classList.add('active');
        list[16].classList.add('active');
        list[17].classList.add('active');
        list[18].classList.add('active');


    }
    if (buttom == 'teste') {

        list[19].classList.add('active');
        list[20].classList.add('active');
        list[21].classList.add('active');
        list[22].classList.add('active');
        list[23].classList.add('active');
        list[24].classList.add('active');
        list[25].classList.add('active');
    }
    if (buttom == 'all') {
        list[0].classList.add('active');
        list[1].classList.add('active');
...
buttomGeral.forEach((item) => {
    item.addEventListener('click', (e) => {
        ...
        if (currentButtom.classList.contains('teste')) {
            showList(listAll, "teste")
        }
        if (currentButtom.classList.contains('all')) {
